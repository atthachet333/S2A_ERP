...
async function main() {
  ...
  const grants: Record<string, string[]> = {
    ...
    PRODUCTION: ['COMPANY_VIEW', 'COMPANY_SWITCH', 'DASHBOARD_VIEW', 'PROFILE_VIEW', 'INGREDIENT_VIEW', 'INGREDIENT_CREATE', 'INGREDIENT_EDIT', 'PACKAGING_VIEW', 'PACKAGING_CREATE', 'PACKAGING_EDIT', 'RECIPE_VIEW', 'RECIPE_CREATE', 'RECIPE_EDIT', 'COSTING_VIEW', 'COSTING_CALCULATE', 'STOCK_VIEW', 'RECEIVING_VIEW', 'NOTIFICATION_VIEW', 'DOCUMENT_DOWNLOAD'],
    PURCHASING: ['COMPANY_VIEW', 'COMPANY_SWITCH', 'DASHBOARD_VIEW', 'PROFILE_VIEW', 'INGREDIENT_VIEW', 'INGREDIENT_CREATE', 'INGREDIENT_EDIT', 'PACKAGING_VIEW', 'PACKAGING_CREATE', 'PACKAGING_EDIT', 'RECEIVING_VIEW', 'RECEIVING_CREATE', 'RECEIVING_EDIT', 'STOCK_VIEW', 'NOTIFICATION_VIEW', 'DOCUMENT_DOWNLOAD'],
